...
> APPROVE，详见 §7.5）。
> **迭代八已落地（2026-08-12，HEAD = 9f9606e）**：进程级故障注入演练套件 `scripts/drills/`
...
> kill-mid-operation / delay-proxy〕+ RESULTS.md 结果登记表 + 内嵌 .gitignore）入库（**本批提交**，
> 提交号待总指挥提交后回填）：覆盖设计 §19.3 剩余 4 项中的 3 项（产品进程在任务中被终止 /
